...
const debug = require('debug')('server-stats:mem-component');


/**
 * Represents the component that renders the serverStatus['mem'] information.
 */
class MemComponent extends React.Component {
...
MemComponent.displayName = 'MemComponent';

module.exports = MemComponent;